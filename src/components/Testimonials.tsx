      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((review, index) => (
            <div
              key={index}
              className="p-6 bg-white rounded-lg shadow-md flex flex-col h-full text-left"
            >
              ...
              <p className="italic text-neutral-slate flex-grow flex items-center justify-center">
                &quot;{review.review}&quot;
              </p>
